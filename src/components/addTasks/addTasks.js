  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between">
        ...
        <button
          type="button"
          className="w-6 h-6 rounded-full ring-gray-500 ring-2 flex items-center justify-center group text-lg hover:rotate-180 transition-all ease-in-out duration-500 text-slate-700 dark:text-gray-100"
          onClick={() => dispatch(toggleTaskBtn())}
        >
          <FiX />
        </button>
        ...
        <div className="space-y-4">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <select
                className="bg-gray-100 dark:bg-[#041955] border border-gray-300 text-slate-700 dark:text-gray-100 text-sm rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 form-select"
...
const SetColors = ({
  ...
  return (
    <>
      ...
      {toggleColor && (
        <div className="p-2 bg-white dark:bg-[#041955] rounded-md flex items-center gap-2 absolute right-8 top-16 w-40 flex-wrap justify-center shadow-md">
          {colors.map((color, i) => (
            <span
              key={i}
